...
export function ClientBookingView() {
  ...
  const { data: slots, loading: slotsLoading, error: slotsError, reload: reloadSlots } = useApi<SlotResponse>(slotsPath, undefined, { enabled: Boolean(slotsPath) });
